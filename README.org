...
The result of an aggregation may become the source of further processing.  To
do that, just add a =#+TBLNAME:= just above the aggragated table.  Here is an
example of a double aggregation:
