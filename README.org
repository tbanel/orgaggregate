...
- [[#stop-reading-here-8020][Stop reading here! 80/20]]
  - [[#to-summarize-the-20][To summarize the 20%]]
  - [[#keep-it-simple][Keep it simple]]
- [[#equivalent-in-sql-r-datamash-el-tblfn][Equivalent in SQL, R, Datamash, el-tblfn]]
...
* Equivalent in SQL, R, Datamash, el-tblfn
:PROPERTIES:
:CUSTOM_ID: equivalent-in-sql-r-datamash-el-tblfn
:END:
