...
|-------+-------------------------+-------------------------+-----------------------------|
|     0 | <2011-09-24 sam. 13:54> | <2014-02-26 mer. 16:11> | <14089-07-17 sun 11:55> / 7 |
|     1 | <2012-12-25 mar. 00:00> | <2015-09-14 lun. 13:07> |               735355.373438 |
|     2 | <2015-10-02 ven. 17:42> | <2016-01-28 jeu. 15:06> |               735933.683334 |
...
|------------------------+------------------------+--------+--------+---------------|
| <2011-09-24 sat 13:54> | <2014-02-26 wed 16:11> |      1 |      8 | 735074.937066 |
#+END
...
#+BEGIN: aggregate :table "emptyinput" :cols "T sum(Q) prod(Q) (Q)"
| T                | sum(Q) | prod(Q) | (Q)              |
|------------------+--------+---------+------------------|
| no-blank         |      6 |       6 | [1, 2, 3]        |
...
#+BEGIN: aggregate :table "nonnumeric" :cols "hline (N) (N);E (N);N (N);EN"
| hline | (N)           | (N);E               | (N);N            | (N);EN           |
|-------+---------------+---------------------+------------------+------------------|
|     0 | [1, 2, aa, 4] | [1, 2, aa, 'nil, 4] | [1, 2, aa, 0, 4] | [1, 2, aa, 0, 4] |
#+END:

#+BEGIN: aggregate :table "nonnumeric" :cols "mean(N) mean(N);E mean(N);N mean(N);EN"
| mean(N)       | mean(N);E                  | mean(N);N    | mean(N);EN   |
|---------------+----------------------------+--------------+--------------|
| aa / 4 + 1.75 | vmean([1, 2, aa, 'nil, 4]) | aa / 5 + 1.4 | aa / 5 + 1.4 |
#+END:
...
| A | sum(Q)                             | sum(R)                               |
|---+------------------------------------+--------------------------------------|
| a | 3 + error(2, '"Expected a number") | 30                                   |
